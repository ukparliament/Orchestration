namespace Functions.TransformationConstituencyOS
{
    ...
    public partial class Polygon
    {
        ...
        private PolygonOuterBoundaryIs outerBoundaryIsField;

        /// <remarks/>
        public PolygonOuterBoundaryIs outerBoundaryIs
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class PolygonOuterBoundaryIs
    {

        private string[] linearRingField;

        /// <remarks/>
        [System.Xml.Serialization.XmlArrayItemAttribute("coordinates", IsNullable = false)]
