...
namespace Functions.Transformation
{
    public static class TransformationContactPointElectoralMnis
    {
        ...
        construct {
            ...
            ?incumbency parl:electoralIncumbencyHasContactPoint ?contactPoint.
        }
        where {
            ...
            optional {?incumbency parl:electoralIncumbencyHasContactPoint ?contactPoint}
        }";

        [FunctionName("TransformationContactPointElectoralMnis")]
        public static async Task<object> Run([HttpTrigger(WebHookType = "genericJson")]HttpRequestMessage req, TraceWriter log)
        {
            telemetryClient.Context.Operation.Name = "TransformationContactPointElectoralMnis";
